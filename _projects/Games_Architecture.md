...
video: <iframe width="1280" height="720" src="https://www.youtube.com/embed/JxgcTvy3u60" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
---
...
At first using ECS architecture resulted in the few couple of weeks of development being quite slow, however I quickly realised that most systems / components were very similar, not enough to combine but enough to ‘template’. Overall with ECS once I got the hang of it I quite enjoyed that I could quickly make entities knowing that in most cases the Entity will just work as intended.

Knowing what the end game would be, lead to a few design decisions that would hinder development of another game using the same game engine. One of which was input, in my implementation I had a input manager which knew what controls to look for and what they affected. This could easily be fixed by allowing the developer to choose and map the input to a delegate (or other such method).
